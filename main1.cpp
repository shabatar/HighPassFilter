...
void SWT(const Mat &src_Original, Mat &ca, Mat &ch, Mat &cd, Mat &cv, int Level, MotherWavelet Type)
{
    ...
    if (Type == Haar)
    {
        ...
        for (int i = 0; i < Level; i++)
        {
            ...
            DyadicUpsample(Kernel_High);
            DyadicUpsample(Kernel_Low);
...
int main ()
{
    ...
    auto * window_name = const_cast<char *>("filter2D Demo");
    int level = 1;

    /// Load an image
    //src = imread("/Users/kata/Downloads/azimut_example/000000000.jpg", CV_LOAD_IMAGE_GRAYSCALE);
    src = imread("/Users/kata/Documents/2.jpg", CV_LOAD_IMAGE_GRAYSCALE);
    ...
    imwrite("/Users/kata/Documents/21.jpg", src);
